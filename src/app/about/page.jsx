...
const AboutPage = async () => {
  ...
  const text = [
    ...
    "‏‎בשלב מסוים החלטתי לקחת את התחביב הזה צעד קדימה כדי להמשיך ליצור. ‎האתר הזה הוא המקום שבו תוכלו להיחשף ליצירות שלי, עבודות בברזל ועץ שנעשו באהבה ובתכנון מוקפד, באיכות גבוהה ועם תשומת לב לפרטים הקטנים.",
    "מוזמנים להתרשם ולהתעניין בכל פרויקט שיכול להתאים לכם, כמובן, אני כאן גם כדי לענות על כל שאלה או לסייע בפרויקטים בהתאמה אישית.",
